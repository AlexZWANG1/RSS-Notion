...
- **来源多样性**：最终精选结果中，5 个 channel 分类每个至少出现 1 次。如果某个分类确实没有值得入选的内容，在 run_report 中说明原因。
- **长内容保底**：YouTube 视频和播客是高价值独家内容（一小时深度对话的信息密度远超一篇博文）。最终精选中「长内容/播客」分类 **至少 2 条**，优先选近 7 天内的新视频/播客。即使其他来源竞争激烈，也不能把长内容挤掉。
